...
FactoryBot.define do
  factory :tourism_collaboration do
    ...
    partnership_details do
      {
        budget_contribution: budget_contribution_amount,
        resource_sharing: resource_sharing_list,
        collaboration_scope: collaboration_scope_details,
        deliverables: expected_deliverables,
        timeline: collaboration_timeline,
        contact_persons: contact_person_details
      }.to_json
    end
    ...
    marketing_campaigns do
      {
        ...
        print_media: print_media_campaign,
        digital_advertising: digital_advertising_campaign,
        events_promotion: events_promotion_campaign,
    ...
    visitor_analytics do
      {
        ...
        economic_impact: 0,
        satisfaction_scores: default_satisfaction_scores,
        source_analysis: visitor_source_analysis,
        spending_patterns: spending_pattern_data
      }.to_json
    end
      ...
      visitor_analytics do
        {
          ...
          demographics: populated_demographics,
          economic_impact: rand(50000..200000),
          satisfaction_scores: positive_satisfaction_scores,
          source_analysis: visitor_source_analysis,
          spending_patterns: spending_pattern_data
        }.to_json
      end
      ...
      visitor_analytics do
        {
          ...
          satisfaction_scores: final_satisfaction_scores,
          source_analysis: final_visitor_source_analysis,
          spending_patterns: final_spending_pattern_data
        }.to_json
      end
    end
      ...
      visitor_analytics do
        {
          ...
          demographics: high_impact_demographics,
          economic_impact: rand(300000..1000000),
          satisfaction_scores: excellent_satisfaction_scores,
          source_analysis: diverse_visitor_sources,
          spending_patterns: high_spending_patterns
        }.to_json
      end
    end
    ...
    def budget_contribution_amount
    ...
    def collaboration_scope_details
      case collaboration_type
      when 'tourism_board'
    ...
    def digital_advertising_campaign
      {
    ...
    def total_marketing_budget
      social_media_campaign[:budget] + 
      print_media_campaign[:budget] + 
      digital_advertising_campaign[:budget] + 
      events_promotion_campaign[:budget]
    end
    ...
    def default_satisfaction_scores
      {
    ...
    def positive_satisfaction_scores
      {
    ...
    def excellent_satisfaction_scores
      {
    ...
    def final_visitor_source_analysis
      {
        marketing_channels: {
    ...
    def final_spending_pattern_data
      {
